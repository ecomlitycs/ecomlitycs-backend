            ...
            <div className="relative">
                <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-1.5 rounded-lg border transition-colors text-sm font-semibold ${
                        ...
                        : 'bg-card-alt text-foreground hover:bg-border border-border'
                    }`}
                >
                ...
                {isPopoverOpen && (
                    <div ref={popoverRef} className="absolute right-0 mt-2 w-72 bg-card rounded-xl border border-border shadow-lg z-10 p-4 animate-fade-in-up">
                        <p className="text-sm font-semibold mb-2 text-foreground">Intervalo Personalizado</p>
                        <div className="space-y-2">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-background border border-border rounded-md px-2 py-1.5 text-sm font-semibold"
                                />
                            </div>
                            <div>
